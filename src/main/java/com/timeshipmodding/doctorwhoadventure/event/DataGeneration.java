package com.timeshipmodding.doctorwhoadventure.event;

import com.timeshipmodding.doctorwhoadventure.DoctorWhoAdventure;
import com.timeshipmodding.doctorwhoadventure.datagen.DataBlockStates;
import com.timeshipmodding.doctorwhoadventure.datagen.DataItemModels;
import com.timeshipmodding.doctorwhoadventure.datagen.DataRecipes;
import com.timeshipmodding.doctorwhoadventure.datagen.loot.DataBlockLootTables;
import com.timeshipmodding.doctorwhoadventure.datagen.tags.DataBlockTags;
import com.timeshipmodding.doctorwhoadventure.datagen.tags.DataItemTags;
...
@EventBusSubscriber(modid = DoctorWhoAdventure.MODID, bus = EventBusSubscriber.Bus.MOD)
