...
public class TardisTab {
    ...
    public static final RegistryObject<CreativeModeTab> TARDIS_TAB = CREATIVE_MODE_TABS.register("tardis_tab", () ->
            CreativeModeTab.builder()
                    .title(Component.translatable("creativemodetab.dw_adventure.tardis_tab"))
