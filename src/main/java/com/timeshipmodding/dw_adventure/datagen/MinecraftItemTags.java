...
public class MinecraftItemTags extends ItemTagsProvider {
    public MinecraftItemTags(PackOutput p_275343_, CompletableFuture<HolderLookup.Provider> p_275729_,
